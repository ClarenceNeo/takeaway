...
CREATE TABLE `user` (
  ...
  `create_at` int(10) unsigned DEFAULT NULL,
  `update_at` int(10) unsigned DEFAULT NULL,
  `premission` varchar(24) NOT NULL DEFAULT 'user',
  PRIMARY KEY (`id`)
...
INSERT INTO `user` VALUES (13,'hhh','555',NULL,NULL,NULL,'user'),(15,'lsd','123',NULL,NULL,NULL,'user'),(16,'lsd','123',NULL,NULL,NULL,'user'),(17,'lsd','123',NULL,NULL,NULL,'user'),(18,'lsd','123',NULL,NULL,NULL,'user'),(19,'lsd','123',NULL,NULL,NULL,'user'),(20,'lsd','123',NULL,NULL,NULL,'user'),(21,'lsd','123',NULL,NULL,NULL,'user'),(22,'lsd','123',NULL,NULL,NULL,'user'),(24,'aaaa','123456',NULL,NULL,NULL,'user'),(25,'user1','123456',NULL,NULL,NULL,'user'),(26,'user2','3298c528f03f541ca4b41a3a4ba70aac',NULL,NULL,NULL,'user'),(27,'user3','3298c528f03f541ca4b41a3a4ba70aac',NULL,NULL,NULL,'admin');
...
-- Dump completed on 2017-12-19 17:01:46
