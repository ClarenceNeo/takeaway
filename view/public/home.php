...
<div class="place footer">
  <div class="row bottom-nav">
    <div class="col col-4">
      <h3 class="">用户帮助</h3>
      <a class="bottom-nav-item" href="">常见问题</a>
    </div>
    <div class="col col-4">
      <h3 class="">商务合作</h3>
      <a class="bottom-nav-item" href="">我要开店</a>
      <a class="bottom-nav-item" href="">加盟指南</a>
      <a class="bottom-nav-item" href="">市场合作</a>
      <a class="bottom-nav-item" href="">开放平台</a>
    </div>
    <div class="col col-4">
      <h3 class="">关于我们</h3>
      <a class="bottom-nav-item" href="">微信</a>
      <a class="bottom-nav-item" href="">新浪微博</a>
    </div>
  </div>
  <div></div>
</div>
